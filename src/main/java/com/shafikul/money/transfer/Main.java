...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            host.addContext(Constants.OPEN_ACCOUNT_PATH, new OpenUserAccount(), Constants.REQUEST_TYPE_POST);
            ...
            host.addContext(Constants.WITH_DRAW_MONEY_PATH, new WithDrawMoneyFromAccount(),
                    Constants.REQUEST_TYPE_POST);
